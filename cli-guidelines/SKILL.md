...
3. Implement related help commands
4. Validate the generated code conforms with the guidelines checklist
5. Verify any links to web documentation, github, discord, or other external resources exist and are accurate
...
- [ ] multi-level subcommands follow either a `noun verb` or `verb noun` order pattern
...
- [ ] does not overwrite or modify any [POSIX standard env vars](#posix-standard-env-vars)
...
- [ ] program name, commands, and subcommands are each 3-8 characters
- [ ] letters are distributed across a QWERTY keyboard
